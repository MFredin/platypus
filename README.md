...
The production URL is configured explicitly as
`https://mfredin.github.io/platypus`, with `/platypus` as Astro's base path. This
avoids repository variables overriding the deployment URL with an empty or
malformed value.
